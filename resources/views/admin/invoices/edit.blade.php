...
document.addEventListener('DOMContentLoaded', function() {
    flatpickr('#invoice_date', {dateFormat: 'Y-m-d', defaultDate: "{{ $invoice->invoice_date->format('Y-m-d') }}"});
    $('.select2').select2();
    let itemRowCount = {{ count($invoice->items) }};
    ...
    (function() {
        ...
        const newRow = document.createElement('tr');
        newRow.innerHTML = `
            <td><input type="text" class="form-control" name="description[]" value="{{ old('description.' . $index, $item->description) }}" required></td>
            <td><input type="number" class="form-control quantity" name="quantity[]" min="1" value="{{ old('quantity.' . $index, $item->quantity) }}" required></td>
            <td><input type="number" class="form-control rate" name="rate[]" min="0" step="0.01" value="{{ old('rate.' . $index, $item->rate) }}" required></td>
            <td><input type="number" class="form-control amount" name="amount[]" value="{{ old('amount.' . $index, $item->amount) }}" readonly></td>
            <td><button type="button" class="btn btn-danger btn-icon btn-sm remove-row" aria-label="Remove item" data-bs-toggle="tooltip" title="Remove item"><i class="ti ti-trash"></i></button></td>
        `;
        tbody.appendChild(newRow);
        const quantityInput = newRow.querySelector('.quantity');
...
<div class="container-xxl flex-grow-1 container-p-y">
    <form action="{{ route('admin.invoices.update', $invoice->id) }}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
        <!-- Sticky Action Bar -->
        <div class="sticky-top bg-white py-2 mb-3 border-bottom d-flex justify-content-between align-items-center" style="z-index: 10;">
            <h4 class="mb-0"><i class="ti ti-file-invoice me-2"></i>Edit Invoice</h4>
            <!-- <div>
        ...
        <div class="row g-4">
                ...
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg @error('invoice_no') is-invalid @enderror" id="invoice_no" name="invoice_no" value="{{ old('invoice_no', $invoice->invoice_no) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('invoice_date') is-invalid @enderror" id="invoice_date" name="invoice_date" value="{{ old('invoice_date', $invoice->invoice_date->format('Y-m-d')) }}" required aria-label="Invoice Date">
                ...
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('bill_company_name') is-invalid @enderror" id="bill_company_name" name="bill_company_name" value="{{ old('bill_company_name', $invoice->billTo->company_name) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('bill_address') is-invalid @enderror" id="bill_address" name="bill_address" rows="2" required>{{ old('bill_address', $invoice->billTo->address) }}</textarea>
                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('bill_vat_no') is-invalid @enderror" id="bill_vat_no" name="bill_vat_no" value="{{ old('bill_vat_no', $invoice->billTo->vat_no) }}" required>
                                @error('bill_vat_no')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6">
                                <label for="bill_eori" class="form-label">EORI</label>
                                <input type="text" class="form-control @error('bill_eori') is-invalid @enderror" id="bill_eori" name="bill_eori" value="{{ old('bill_eori', $invoice->billTo->eori) }}" required>
                        ...
                        <div class="row g-2 mt-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('bill_phone') is-invalid @enderror" id="bill_phone" name="bill_phone" value="{{ old('bill_phone', $invoice->billTo->phone) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control @error('bill_email') is-invalid @enderror" id="bill_email" name="bill_email" value="{{ old('bill_email', $invoice->billTo->email) }}" required aria-label="Bill To Email">
                ...
                <div class="card shadow-sm h-100 mt-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ship_company_name') is-invalid @enderror" id="ship_company_name" name="ship_company_name" value="{{ old('ship_company_name', $invoice->shipTo->company_name) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('ship_address') is-invalid @enderror" id="ship_address" name="ship_address" rows="2" required>{{ old('ship_address', $invoice->shipTo->address) }}</textarea>
                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('ship_vat_no') is-invalid @enderror" id="ship_vat_no" name="ship_vat_no" value="{{ old('ship_vat_no', $invoice->shipTo->vat_no) }}" required>
                                @error('ship_vat_no')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6">
                                <label for="ship_eori" class="form-label">EORI</label>
                                <input type="text" class="form-control @error('ship_eori') is-invalid @enderror" id="ship_eori" name="ship_eori" value="{{ old('ship_eori', $invoice->shipTo->eori) }}" required>
                        ...
                        <div class="row g-2 mt-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('ship_phone') is-invalid @enderror" id="ship_phone" name="ship_phone" value="{{ old('ship_phone', $invoice->shipTo->phone) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="ti ti-mail"></i></span>
                                    <input type="email" class="form-control @error('ship_email') is-invalid @enderror" id="ship_email" name="ship_email" value="{{ old('ship_email', $invoice->shipTo->email) }}" required aria-label="Ship To Email">
                ...
                <div class="card shadow-sm h-100 mt-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ship_via') is-invalid @enderror" id="ship_via" name="ship_via" value="{{ old('ship_via', $invoice->ship_via) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tracking_no') is-invalid @enderror" id="tracking_no" name="tracking_no" value="{{ old('tracking_no', $invoice->tracking_no) }}" required>
                            @error('tracking_no')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mb-3">
                            <label for="tax_id" class="form-label">Tax ID</label>
                            <input type="text" class="form-control @error('tax_id') is-invalid @enderror" id="tax_id" name="tax_id" value="{{ old('tax_id', $invoice->tax_id) }}">
                ...
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="subtotal" name="subtotal" value="{{ old('subtotal', $invoice->subtotal) }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="shipping" class="form-label">Shipping ($)</label>
                            <input type="number" class="form-control @error('shipping') is-invalid @enderror" id="shipping" name="shipping" value="{{ old('shipping', $invoice->shipping) }}" required>
                            @error('shipping')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mb-3">
                            <label for="total" class="form-label">Total ($)</label>
                            <input type="number" class="form-control" id="total" name="total" value="{{ old('total', $invoice->total) }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="paid" class="form-label">Paid ($)</label>
                            <input type="number" class="form-control @error('paid') is-invalid @enderror" id="paid" name="paid" value="{{ old('paid', $invoice->paid) }}" required>
            ...
            <div class="col-12 col-lg-6 mt-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <textarea class="form-control @error('notes') is-invalid @enderror" name="notes" rows="4" placeholder="Additional notes...">{{ old('notes', $invoice->notes) }}</textarea>
                    ...
                    <div class="card-body">
                                ...
                                <select class="form-control @error('payment_instruction_option') is-invalid @enderror" id="payment_instruction_option" name="payment_instruction_option" required>
                                    ...
                                    @foreach($paymentInstructionOptions as $option)
                                        <option value="{{ $option->option_name }}" 
                                                ...
                                                {{ old('payment_instruction_option', $invoice->paymentInstructions->payment_instruction_option) == $option->option_name ? 'selected' : '' }}>
                                            {{ $option->option_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control @error('account_name') is-invalid @enderror" id="account_name" name="account_name" value="{{ old('account_name', $invoice->paymentInstructions->account_name) }}" required>
                                @error('account_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label for="account_number" class="form-label">Account Number</label>
                                <input type="text" class="form-control @error('account_number') is-invalid @enderror" id="account_number" name="account_number" value="{{ old('account_number', $invoice->paymentInstructions->account_number) }}" required>
                                @error('account_number')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label for="bank_code" class="form-label">Bank Code</label>
                                <input type="text" class="form-control @error('bank_code') is-invalid @enderror" id="bank_code" name="bank_code" value="{{ old('bank_code', $invoice->paymentInstructions->bank_code) }}" required>
                                @error('bank_code')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label for="branch_code" class="form-label">Branch Code</label>
                                <input type="text" class="form-control @error('branch_code') is-invalid @enderror" id="branch_code" name="branch_code" value="{{ old('branch_code', $invoice->paymentInstructions->branch_code) }}" required>
                                @error('branch_code')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label for="swift_bic" class="form-label">SWIFT/BIC</label>
                                <input type="text" class="form-control @error('swift_bic') is-invalid @enderror" id="swift_bic" name="swift_bic" value="{{ old('swift_bic', $invoice->paymentInstructions->swift_bic) }}" required>
                                @error('swift_bic')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label for="swift_code" class="form-label">SWIFT Code</label>
                                <input type="text" class="form-control @error('swift_code') is-invalid @enderror" id="swift_code" name="swift_code" value="{{ old('swift_code', $invoice->paymentInstructions->swift_code) }}" required>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control @error('account_location') is-invalid @enderror" id="account_location" name="account_location" value="{{ old('account_location', $invoice->paymentInstructions->account_location) }}" required>
                                @error('account_location')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label for="bank_name" class="form-label">Bank Name</label>
                                <input type="text" class="form-control @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name" value="{{ old('bank_name', $invoice->paymentInstructions->bank_name) }}" required>
                                @error('bank_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6">
                                <label for="bank_address" class="form-label">Bank Address</label>
                                <input type="text" class="form-control @error('bank_address') is-invalid @enderror" id="bank_address" name="bank_address" value="{{ old('bank_address', $invoice->paymentInstructions->bank_address) }}" required>
                                @error('bank_address')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label for="account_type" class="form-label">Account Type</label>
                                <input type="text" class="form-control @error('account_type') is-invalid @enderror" id="account_type" name="account_type" value="{{ old('account_type', $invoice->paymentInstructions->account_type) }}" required>
                                @error('account_type')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label for="multi_currency_ac_no" class="form-label">Multi-Currency Account No</label>
                                <input type="text" class="form-control @error('multi_currency_ac_no') is-invalid @enderror" id="multi_currency_ac_no" name="multi_currency_ac_no" value="{{ old('multi_currency_ac_no', $invoice->paymentInstructions->multi_currency_ac_no) }}" required>
